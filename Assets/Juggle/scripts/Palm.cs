...
public class Palm : MonoBehaviour {
    ...
    void OnCollisionStay(Collision col)
    {
       // Debug.Log("test");
        ...
        if ((float)hand.getVelocity( ).magnitude > 1f
            //&& col.gameObject.GetComponent<HeldObject>().parent == null
            )
        {
           ...
           // Destroy(gameObject.GetComponent<FixedJoint>());
            ...
            Debug.Log(tossVector.y);
            col.gameObject.GetComponent<Rigidbody>().AddForce(hand.getVelocity()*30);
